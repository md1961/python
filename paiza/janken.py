...
class Janken:
    def __init__(self, opp_hands, *, debug=False):
        self.opp_hands = opp_hands
        self.f_debug = sys.stderr if debug else DevNull()

    def max_win_with(self, total_fingers):
        return self.__solve_max_win(total_fingers)

    def __solve_max_win(self, total_fingers):
        max_wins = {}
...
if __name__ == '__main__':
    ...
    janken = Janken(opp_hands, debug=debug)
    print(janken.max_win_with(total_fingers))
